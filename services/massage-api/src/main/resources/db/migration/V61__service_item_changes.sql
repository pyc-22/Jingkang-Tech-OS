CREATE TABLE service_session_item_change_log (
  id UUID PRIMARY KEY,
...
CREATE INDEX service_session_item_change_session_idx ON service_session_item_change_log(store_id, service_session_id, changed_at DESC);
